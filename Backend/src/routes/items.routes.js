...
import schemas from "#schemas/items.schema.js";
...
router.get(
  '/lists/items', 
  itemsController.getItemsByUserId
);

// INSERT INTO items new records
router.post(
  '/lists/:list_id/items',
  schemaMiddleware(schemas.ItemPostSchema),
...
router.patch(
  '/lists/:list_id/items/:item_id', 
  schemaMiddleware(schemas.ItemPachtSchema),
